      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <a className="flex justify-center ">
            <h2 className="text-3xl font-semibold font-second">Khan Tailor</h2>
          </a>
          <ul className="text-lg font-second flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
            <li>
          ...
          <span className="text-lg text-gray-500 text-center block">
            ©<a href="https://pagedone.io/">Khan's</a> 2024, All rights
            reserved.
          </span>
        </div>
      </div>
